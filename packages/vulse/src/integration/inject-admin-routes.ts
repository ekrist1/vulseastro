...
export function injectVulseAdminRoutes({ injectRoute, logger, adminPath = '/admin' }: InjectAdminArgs) {
  ...
  const routes: Array<{ pattern: string; file: string }> = [
    ...
    { pattern: `${prefix}/forms/[handle]`, file: 'forms/[handle].astro' },
    { pattern: `${prefix}/forms/[handle]/submissions`, file: 'forms/[handle]/submissions/index.astro' },
    { pattern: `${prefix}/forms/[handle]/submissions/[id]`, file: 'forms/[handle]/submissions/[id].astro' },
    ...
    { pattern: `${prefix}/schema/import`, file: 'schema/import.astro' },
