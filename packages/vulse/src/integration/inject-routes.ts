...
export function injectVulseRoutes({ injectRoute, logger }: InjectArgs) {
  const routes: Array<{ pattern: string; file: string }> = [
    ...
    { pattern: '/api/vulse/blueprints/import', file: 'api-vulse-blueprints-import.js' },
    { pattern: '/api/vulse/blueprints/templates', file: 'api-vulse-blueprints-templates.js' },
    { pattern: '/api/vulse/blueprints/templates/import', file: 'api-vulse-blueprints-template-import.js' },
